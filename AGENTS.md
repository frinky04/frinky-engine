...
- **`TransformVersion` editor visibility** — `TransformVersion` is internal cache/versioning state for transforms, not user-authored data. Keep it hidden in the inspector.
